...
#ifndef __Vector_H__
#define __Vector_H__
//C:\Users\temun\source\repos\Game And Graphics III - Final Project\Libraries\Box2D\Box2D\Common\b2Settings.h
#include "../../../Libraries/Box2D/Box2D/Common/b2Settings.h"
...
public:
    ...
    Vector3(btVector3 vec) { x = vec.getX(); y = vec.getY(); z = vec.getZ(); }
    ...
    inline Vector3 Add(const btVector3& o) const { return Vector3(this->x + o.getX(), this->y + o.getY(), this->z + o.getZ()); }
    inline Vector3 Sub(const Vector3& o) const { return Vector3(this->x - o.x, this->y - o.y, this->z - o.z); }
    inline Vector3 Sub(const btVector3& o) const { return Vector3(this->x - o.getX(), this->y - o.getY(), this->z - o.getZ()); }
    ...
    inline Vector3 MultiplyComponents(const btVector3& o) const { return Vector3(this->x * o.getX(), this->y * o.getY(), this->z * o.getZ()); }
    inline Vector3 DivideComponents(const Vector3& o) const { return Vector3(this->x / o.x, this->y / o.y, this->z / o.z); }
    inline Vector3 DivideComponents(const btVector3& o) const { return Vector3(this->x / o.getX(), this->y / o.getY(), this->z / o.getZ()); }
    ...
    inline bool operator !=(const Vector3& o) const { return !fequal(this->x, o.x) || !fequal(this->y, o.y) || !fequal(this->z, o.z); }
    inline bool operator ==(const btVector3& o) const { return fequal(this->x, o.getX()) && fequal(this->y, o.getY()) && fequal(this->z, o.getZ()); }
    inline bool operator !=(const btVector3& o) const { return !fequal(this->x, o.getX()) || !fequal(this->y, o.getY()) || !fequal(this->z, o.getZ()); }
    ...
    inline Vector3 operator +(const Vector3& o) const { return Vector3(this->x + o.x, this->y + o.y, this->z + o.z); }
    inline Vector3 operator -(const Vector3& o) const { return Vector3(this->x - o.x, this->y - o.y, this->z - o.z); }
    inline Vector3 operator *(const btVector3& o) const { return Vector3(this->x * o.getX(), this->y * o.getY(), this->z * o.getZ()); }
    inline Vector3 operator /(const btVector3& o) const { return Vector3(this->x / o.getX(), this->y / o.getY(), this->z / o.getZ()); }
    inline Vector3 operator +(const btVector3& o) const { return Vector3(this->x + o.getX(), this->y + o.getY(), this->z + o.getZ()); }
    inline Vector3 operator -(const btVector3& o) const { return Vector3(this->x - o.getX(), this->y - o.getY(), this->z - o.getZ()); }
    ...
    inline Vector3 operator +=(const Vector3& o) { this->x += o.x; this->y += o.y; this->z += o.z; return *this; }
    inline Vector3 operator -=(const Vector3& o) { this->x -= o.x; this->y -= o.y; this->z -= o.z; return *this; }
    inline Vector3 operator *=(const btVector3& o) { this->x *= o.getX(); this->y *= o.getY(); this->z *= o.getZ(); return *this; }
    inline Vector3 operator /=(const btVector3& o) { this->x /= o.getX(); this->y /= o.getY(); this->z /= o.getZ(); return *this; }
    inline Vector3 operator +=(const btVector3& o) { this->x += o.getX(); this->y += o.getY(); this->z += o.getZ(); return *this; }
    inline Vector3 operator -=(const btVector3& o) { this->x -= o.getX(); this->y -= o.getY(); this->z -= o.getZ(); return *this; }

    //inline Vector3 operator =(const btVector3& o) { this->x = o.x; this->y = o.y; this->z = o.z; return *this; }
    inline operator btVector3() { return btVector3((float32)this->x, (float32)this->y, (float32)this->z); }
